...
import com.mikevogel.events.validator.UserValidator;
...
public class UsersController {
    ...
    public String home(
        ...
        model.addAttribute("events", eventService.getByState(state));
        model.addAttribute("allEvents", eventService.getAllMinus(state));
